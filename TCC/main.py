...
# Ordenando o DataFrame pelo valor da coluna 'id_data' e 'id_valor'
df = df.sort_values(by=['id_data', 'id_valor'])

# Renomeando as colunas para palavras mais apresentáveis
...
# Paleta de cores para o gráfico de distribuição por origem
paleta_cores_origem = {'Origem': {'Amarelo': '#FFFF00', 'Verde': '#008000', 'Vermelho': '#FF0000', 'Azul': '#0000FF', 'Roxo': '#800080'}}

# Paleta de cores para o gráfico de distribuição por destino
